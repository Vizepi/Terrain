...
int main(int argc, char *argv[])
{
	...
	builder.SetInfluencePoint(3, Vector2(1000, -1000), 2000);
	...
	Terrain t(builder, 1000, AABB3(Vector3(-5000, -5000, 1000), Vector3(5000, 5000, 4000)), 666, true);
	//t.Ridge(ridge, Vector2(3500, 2500));
    t.Gradient();
	...
	t.Erode(100000, 0, 25, 1.0, 0.0, 1.0, 10, 1.0);
	t.Ridge(ridge, Vector2(3500, 2500));
